    ...
    <main class="form">
        ...
        <div class="formContainer">
            <div class="idform" v-show="isTabActive('idbtn')">
                <div class="one">
                    <input type="tel" @input="validatePhoneNumber" class="form-control" minlength="10" maxlength="11" placeholder="- 없이 숫자만 입력" v-model="user_ph" />
            ...
            <div class="pwform" v-show="isTabActive('pwbtn')">
                ...
                <div class="three">
                    <input type="tel" @input="validatePhoneNumber" class="form-control" minlength="11" maxlength="11" placeholder="- 없이 숫자만 입력" v-model="user_ph" />
    ...
    methods: {
        ...
        findPW() {
            if (this.user_id === '' || this.user_ph === '') {
                this.$swal('아이디와 휴대전화번호를 입력해주세요');
            } else {
                axios
                    .post('http://localhost:3000/auth/findPw', {
